...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>OLIVE GARDEN - Reservations</title>
    <style>
        body {
            margin: 0;
            font-family: 'Arial', sans-serif;
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>OLIVE GARDEN - Contact Us</title>
    <style>
        body {
            margin: 0;
            font-family: 'Arial', sans-serif;
...
<body>
    ...
    <section class="contact-section">
        <div class="contact-details">
            ...
            <p><strong>Address:</strong> 123 Olive Garden,Salem,Tamilnadu, India</p>
            <p><strong>Phone:</strong> +91 9345966818</p>
            <p><strong>Email:</strong> contact@olivegarden.com</p>
    ...
    <div class="admin-container">
        ...
        <div class="admin-items">
            <div class="admin-item">
                <img src="jaasir.jpeg" alt="CEO">
                <div class="admin-details">
                    <h3>Jaasir Sulthan</h3>
                    <p>CEO - Leading Olive Garden with a vision of excellence and innovation in hospitality.</p>
                </div>
            </div>
            ...
            <div class="admin-item">
                <img src="abijith.jpeg" alt="Master Chef">
                <div class="admin-details">
                    <h3>Abijith</h3>
            ...
            <div class="admin-item">
                <img src="pradeep.jpeg" alt="Assistant Managing Director">
                <div class="admin-details">
                    <h3>Pradeep</h3>
